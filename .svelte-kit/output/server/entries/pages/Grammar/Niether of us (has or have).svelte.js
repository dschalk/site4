...
const Nietheru20ofu20usu20_hasu20oru20have = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<h2>Singular or plural?</h2>
...
<li>Neither of the two rooms you wanted is/are available.</li></ul>
...
<li>Neither student knows the answer.</li></ul>
...
<li>Formal: Either of these is fine.</li></ul>

<ul>EXAMPLES
<li>Neither of these candidates is suitable for the job.</li>
<li>Neither of the lawnmowers is available.</li></ul>
${slots.default ? slots.default({}) : ``}`;
});
export { Nietheru20ofu20usu20_hasu20oru20have as default };
