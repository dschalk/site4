...
/* empty css                                                                 */var game_svelte_svelte_type_style_lang = "";
const css = {
...
<button style="${"display: " + escape(b0)}" class="${"svelte-1pzbx45"}">${escape(AA)}</button> 
<button style="${"display: " + escape(b1)}" class="${"svelte-1pzbx45"}">${escape(BB)}</button> 
<button style="${"display: " + escape(b2)}" class="${"svelte-1pzbx45"}">${escape(CC)}</button> 
<button style="${"display: " + escape(b3)}" class="${"svelte-1pzbx45"}">${escape(DD)}</button>

<br><br>
<button class="${"svelte-1pzbx45"}">ROLL</button>
<br><br>
<button style="${"display: " + escape(b4)}" class="${"svelte-1pzbx45"}">${escape(WW)}</button> 
<button style="${"display: " + escape(b5)}" class="${"svelte-1pzbx45"}">${escape(XX)}</button> 
<button style="${"display: " + escape(b6)}" class="${"svelte-1pzbx45"}">${escape(YY)}</button> 
<button style="${"display: " + escape(b7)}" class="${"svelte-1pzbx45"}">${escape(ZZ)}</button>
