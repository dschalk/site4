<svelte:head>
	<title>Practice the five-block method.</title>
</svelte:head>
...
<script>
   ...
   console.log("ARR is", ARR);
    ...
    <span   id = 0 on:click = {() => sky([0, ARR[0]] )}><img src={BB[ARR[0]]}></span>
    <span   id = 1 on:click = {() => sky([1, ARR[1]] )}><img src={BB[ARR[1]]}></span>
    <span   id = 2 on:click = {() => sky([2, ARR[2]] )}><img src={BB[ARR[2]]}></span>
    <span   id = 3 on:click = {() => sky([3, ARR[3]] )}><img src={BB[ARR[3]]}></span>
    <span   id = 4 on:click = {() => sky([4, ARR[4]] )}><img src={BB[ARR[4]]}></span>
    <span   id = 5 on:click = {() => sky([5, ARR[5]] )}><img src={BB[ARR[5]]}></span>
    <span   id = 6 on:click = {() => sky([6, ARR[6]] )}><img src={BB[ARR[6]]}></span>
    <span   id = 7 on:click = {() => sky([7, ARR[7]] )}><img src={BB[ARR[7]]}></span>
    <span   id = 8 on:click = {() => sky([8, ARR[8]] )}><img src={BB[ARR[8]]}></span>
    <span   id = 9 on:click = {() => sky([9, ARR[9]] )}><img src={BB[ARR[9]]}></span>
    <span   id = 10 on:click = {() => sky([10, ARR[10]] )}><img src={BB[ARR[10]]}></span>
    <span   id = 11 on:click = {() => sky([11, ARR[11]] )}><img src={BB[ARR[11]]}></span>
    <span   id = 12 on:click = {() => sky([12, ARR[12]] )}><img src={BB[ARR[12]]}></span>
    <span> . </span>
    <span   id = 13 on:click = {() => sky([13, ARR[13]] )}><img src={BB[ARR[13]]}></span>
    </div>
    ...
    <p>JOE is {JOE}</p>
    <br><br>
    <div>{B.forEach(s => PETE.push(xyz[s]))}</div>
