import{S as De,i as Te,s as we,k as c,e as n,t as l,Q as ye,d as t,m as d,c as i,a as b,h as p,f as se,b as he,g as r,G as o,K as ve,M as ke,N as xe,O as _e}from"../../chunks/vendor-7ab9b2a4.js";function $e(u){let m,s,C,I,g,G,S,L,h,J,O,x,K,P,_,Y,M,f,j,D,Q,Z,W,T,X,A,E,N,w,ee,V,y,te,z,F,R,v,ae,U,k,re,q,$,oe,B;return{c(){m=c(),s=n("div"),C=n("br"),I=l(`
  The Game of Score`),G=c(),S=n("p"),L=l("This page displays the Haskell programming language code that can display unique simulated rolls of the dice and keep score in each of arbitrarily many groups of people playing and chatting among themselves. It can display every possible way a roll of dice -- two six-sided, one twelve-sided and one twenty-sided by default-- can produce the number 20 through addition, subtraction, multiplication, division, and concatination. You can see it in action at "),h=n("a"),J=l("The Game of Score"),O=c(),x=n("p"),K=l("Main.hs, the center of the WebSockets back end, imports whole packages when all it needs is one or two of the functions they contain. It and its helper modules aren't annotated. The JavaScript front end is build on React, a framework I abandoned long ago. It too could use some refactoring, or else re-writing in this SvelteKit framework. I won't let sprucing up the Game of Score interfere with other things I'm doing right now, but maybe later."),P=c(),_=n("p"),Y=l("The work I did was for my young son Alex, a little grade school boy back then. He's twenty-years-old now."),M=c(),f=n("p"),j=l(`I admit I'm pretty sentimental about this game. I remember Alex's asking me if I could compute all possible solutions to all possible rolls of the dice. I said I didn't think so, but then I did it, more to my surprise than Alex's. Then I computed the short list of rolls that couldn't make the number 20, the "impossibles" (bellow). All of this is preserved at Github.com at `),D=n("a"),Q=l("score3"),Z=l("."),W=c(),T=n("pre"),X=l(u[0]),A=c(),E=n("br"),N=c(),w=n("p"),ee=l("This module, among other things, computes any solutions that exist to any particular roll of the four die."),V=c(),y=n("pre"),te=l(u[1]),z=c(),F=n("br"),R=c(),v=n("pre"),ae=l(u[2]),U=c(),k=n("p"),re=l(`Here's the result of running "./impossibles".`),q=c(),$=n("pre"),oe=l(u[3]),this.h()},l(e){ye('[data-svelte="svelte-1afe1jy"]',document.head).forEach(t),m=d(e),s=i(e,"DIV",{style:!0});var ne=b(s);C=i(ne,"BR",{}),I=p(ne,`
  The Game of Score`),ne.forEach(t),G=d(e),S=i(e,"P",{});var ie=b(S);L=p(ie,"This page displays the Haskell programming language code that can display unique simulated rolls of the dice and keep score in each of arbitrarily many groups of people playing and chatting among themselves. It can display every possible way a roll of dice -- two six-sided, one twelve-sided and one twenty-sided by default-- can produce the number 20 through addition, subtraction, multiplication, division, and concatination. You can see it in action at "),h=i(ie,"A",{href:!0});var le=b(h);J=p(le,"The Game of Score"),le.forEach(t),ie.forEach(t),O=d(e),x=i(e,"P",{});var pe=b(x);K=p(pe,"Main.hs, the center of the WebSockets back end, imports whole packages when all it needs is one or two of the functions they contain. It and its helper modules aren't annotated. The JavaScript front end is build on React, a framework I abandoned long ago. It too could use some refactoring, or else re-writing in this SvelteKit framework. I won't let sprucing up the Game of Score interfere with other things I'm doing right now, but maybe later."),pe.forEach(t),P=d(e),_=i(e,"P",{});var ce=b(_);Y=p(ce,"The work I did was for my young son Alex, a little grade school boy back then. He's twenty-years-old now."),ce.forEach(t),M=d(e),f=i(e,"P",{});var H=b(f);j=p(H,`I admit I'm pretty sentimental about this game. I remember Alex's asking me if I could compute all possible solutions to all possible rolls of the dice. I said I didn't think so, but then I did it, more to my surprise than Alex's. Then I computed the short list of rolls that couldn't make the number 20, the "impossibles" (bellow). All of this is preserved at Github.com at `),D=i(H,"A",{href:!0});var de=b(D);Q=p(de,"score3"),de.forEach(t),Z=p(H,"."),H.forEach(t),W=d(e),T=i(e,"PRE",{});var be=b(T);X=p(be,u[0]),be.forEach(t),A=d(e),E=i(e,"BR",{}),N=d(e),w=i(e,"P",{});var ue=b(w);ee=p(ue,"This module, among other things, computes any solutions that exist to any particular roll of the four die."),ue.forEach(t),V=d(e),y=i(e,"PRE",{});var me=b(y);te=p(me,u[1]),me.forEach(t),z=d(e),F=i(e,"BR",{}),R=d(e),v=i(e,"PRE",{});var ge=b(v);ae=p(ge,u[2]),ge.forEach(t),U=d(e),k=i(e,"P",{});var fe=b(k);re=p(fe,`Here's the result of running "./impossibles".`),fe.forEach(t),q=d(e),$=i(e,"PRE",{});var Se=b($);oe=p(Se,u[3]),Se.forEach(t),this.h()},h(){document.title="The Game of Score",se(s,"font-family","Times New Roman"),se(s,"text-align","center"),se(s,"font-size","38px"),he(h,"href","https://game.schalk.site"),he(D,"href","https://github.com/dschalk/score3")},m(e,a){r(e,m,a),r(e,s,a),o(s,C),o(s,I),r(e,G,a),r(e,S,a),o(S,L),o(S,h),o(h,J),r(e,O,a),r(e,x,a),o(x,K),r(e,P,a),r(e,_,a),o(_,Y),r(e,M,a),r(e,f,a),o(f,j),o(f,D),o(D,Q),o(f,Z),r(e,W,a),r(e,T,a),o(T,X),r(e,A,a),r(e,E,a),r(e,N,a),r(e,w,a),o(w,ee),r(e,V,a),r(e,y,a),o(y,te),r(e,z,a),r(e,F,a),r(e,R,a),r(e,v,a),o(v,ae),r(e,U,a),r(e,k,a),o(k,re),r(e,q,a),r(e,$,a),o($,oe),B=!0},p:ve,i(e){B||(ke(()=>{g||(g=xe(s,_e,{},!0)),g.run(1)}),B=!0)},o(e){g||(g=xe(s,_e,{},!1)),g.run(0),B=!1},d(e){e&&t(m),e&&t(s),e&&g&&g.end(),e&&t(G),e&&t(S),e&&t(O),e&&t(x),e&&t(P),e&&t(_),e&&t(M),e&&t(f),e&&t(W),e&&t(T),e&&t(A),e&&t(E),e&&t(N),e&&t(w),e&&t(V),e&&t(y),e&&t(z),e&&t(F),e&&t(R),e&&t(v),e&&t(U),e&&t(k),e&&t(q),e&&t($)}}}function Ce(u){var m=`{-# LANGUAGE OverloadedStrings, TemplateHaskell #-}
...
talk conn state (user, _, _, _) = forever $ do
    ...
    then
        ...
        then
            ...
            do
                print "Hello Jackie" `,s=`{-# LANGUAGE OverloadedStrings #-}
module Fm where
import           Data.List
import qualified Data.Text     as T
...
main :: IO ()
main = rText [111,111,111,111] >>= print `,C=`{-# LANGUAGE OverloadedStrings #-}
...
[6,6,11,12]
[6,6,11,17]
[6,6,12,15] `;return[m,s,C,I]}class Ge extends De{constructor(m){super();Te(this,m,Ce,$e,we,{})}}export{Ge as default};
